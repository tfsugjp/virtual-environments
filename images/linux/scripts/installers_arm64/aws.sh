...
download_with_retries "https://awscli.amazonaws.com/awscli-exe-linux-aarch64.zip" "/tmp" "awscliv2.zip"
unzip -qq /tmp/awscliv2.zip -d /tmp
/tmp/aws/install -i /usr/local/aws-cli -b /usr/local/bin

download_with_retries "https://s3.amazonaws.com/session-manager-downloads/plugin/latest/ubuntu_arm64/session-manager-plugin.deb" "/tmp" "session-manager-plugin.deb"
