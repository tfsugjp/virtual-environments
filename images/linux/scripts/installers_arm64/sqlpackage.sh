...
if isUbuntu22; then
    download_with_retries "http://security.ubuntu.com/ubuntu/pool/main/o/openssl/libssl1.1_1.1.1f-1ubuntu2.17_arm64.deb" "/tmp"
    dpkg -i /tmp/libssl1.1_1.1.1f-1ubuntu2.17_arm64.deb
fi
