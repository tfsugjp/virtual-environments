...
- Microsoft Edge Driver 87.0.664.60
...
| Version | Architecture | Environment Variable |
| ------- | ------------ | -------------------- |
| 1.15.6 (Default) | x64          | GOROOT_1_15_X64      |
...
- 2.1.801 3.1.110 3.1.404 5.0.101
...
| Module  | Version            | Path                           |
| ------- | ------------------ | ------------------------------ |
| Az      | 4.7.0              | C:\Modules\az_\<version\>      |
| Azure   | 5.3.0 [Installed]  | C:\Modules\azure_\<version\>   |
| AzureRM | 6.13.1 [Installed] | C:\Modules\azurerm_\<version\> |
```
